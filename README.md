...
2. **Upload the files.** On the new repository's page, click **uploading an existing file**. Drag in `index.html`, `build_schedule.py`, `research.py`, `friendlies.json`, `overrides.json` and `README.md`, then click **Commit changes**.
