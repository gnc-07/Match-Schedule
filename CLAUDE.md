...
npm test                  # script layout, Python checks, security, axe (80 combinations), then Lighthouse; exits non-zero if anything fails
...
npm run test:axe          # axe-core WCAG 2.2 AA: light/dark, en/pt, 390/1280px; menus closed, Settings, Calendar, Tables (a league and F1), match details, F1 race weekend, high contrast
